...
ggsave(plot1, filename="figures/trials/individual_trajectories_phenotype.png", width=8, height=8, units="in")
```
...
```{r}
plot2a<-full_data%>%
  ggplot(aes(x=timepoint, y=value, colour=phenotype, group=interaction(date, phenotype, temperature)))+
  geom_smooth(stat="smooth")+
  theme_classic();plot2a

ggsave(plot2, filename="figures/trials/phenotype_trajectories.png", width=12, height=12, units="in")
```
