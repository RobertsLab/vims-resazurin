...
### Remove oversaturated samples ADJUST THIS 
...
ggsave(plot2c, filename="figures/trials/family_trajectories.png", width=12, height=12, units="in")
...
ggsave(plot2b, filename="figures/trials/phenotype_trajectories.png", width=12, height=12, units="in")
```

## Calculate change in fluorescence between each timepoint CHANGE TO PERCENT CHANGE 
...
ggsave(plot4, filename="figures/trials/delta_values.png", width=12, height=10, units="in")
...
plot7b<-deltas%>%
  ggplot(aes(x=phenotype, y=delta_T3_T4, colour=phenotype, group=interaction(date, phenotype)))+
  geom_violin()+
...
plot7d<-difference%>%
  ggplot(aes(x=phenotype, y=difference, colour=phenotype, group=interaction(date, family)))+
  geom_violin()+
  theme_classic();plot7d

plot7e<-difference%>%
  ggplot(aes(x=phenotype, y=difference, colour=phenotype, group=interaction(date, phenotype)))+
  geom_violin()+
...
ggsave(plot9, filename="figures/trials/total_values_family.png", width=10, height=8, units="in")
...
Repeatability (R) value is 0.175 here - most variation is within families with little family structure 
...
Heritability = 0.0058 (low heritability, matching family variation above).  
